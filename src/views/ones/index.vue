...
const service = axios.create({ timeout: 180000, baseURL: 'https://sz.ones.cn/' })
...
const submit = (val) => {
    service({ 
        url: '/identity/api/encryption_cert',
        method: 'post'
    })
    service({
    ...
    <div class="ones">
        ...
        <a-form :model="data" :rules="rules" @finish="submit">
            ...
            <a-form-item name="time" label="时间">
                <a-range-picker v-model:value="data.time" placeholder="请输入时间"/>
            </a-form-item>
