    ...
    <div :class="className">
        <div class="status">
            <a-menu mode="horizontal" size="small" :selectable="false">
                <a-menu-item><span class="label">{{ $t('mao.happy') }}</span><a-tag :color="happyColor">{{ happy }}%</a-tag></a-menu-item>
                <a-menu-item><span class="label">{{ $t('mao.food') }}</span><a-tag>{{ resource.foods }}</a-tag></a-menu-item>
                <a-menu-item><span class="label">{{ $t('mao.wood') }}</span><a-tag>{{ resource.woods }}</a-tag></a-menu-item>
                <a-menu-item><span class="label">{{ $t('mao.stone') }}</span><a-tag>{{ resource.stones }}</a-tag></a-menu-item>
                <a-menu-item><span class="label">{{ $t('mao.gold') }}</span><a-tag>{{ resource.golds }}</a-tag></a-menu-item>
            </a-menu>
        </div>
