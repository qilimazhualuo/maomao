import { ipcMain as xo, app as Ie, BrowserWindow as pi } from "electron";
import { createRequire as vo } from "node:module";
import { fileURLToPath as ho } from "node:url";
import Z from "node:path";
import ve from "util";
import $, { Readable as bo } from "stream";
import li from "path";
import Ga from "http";
import Ja from "https";
import Je from "url";
import go from "fs";
import yo from "crypto";
import wo from "assert";
import ui from "tty";
import ko from "os";
import Q from "zlib";
import { EventEmitter as _o } from "events";
function di(e, a) {
  return function() {
    return e.apply(a, arguments);
  };
}
const { toString: Ro } = Object.prototype, { getPrototypeOf: Ka } = Object, Ke = /* @__PURE__ */ ((e) => (a) => {
  const n = Ro.call(a);
  return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), H = (e) => (e = e.toLowerCase(), (a) => Ke(a) === e), Xe = (e) => (a) => typeof a === e, { isArray: he } = Array, we = Xe("undefined");
function Eo(e) {
  return e !== null && !we(e) && e.constructor !== null && !we(e.constructor) && D(e.constructor.isBuffer) && e.constructor.isBuffer(e);
}
const mi = H("ArrayBuffer");
function So(e) {
  let a;
  return typeof ArrayBuffer < "u" && ArrayBuffer.isView ? a = ArrayBuffer.isView(e) : a = e && e.buffer && mi(e.buffer), a;
}
const jo = Xe("string"), D = Xe("function"), fi = Xe("number"), Ye = (e) => e !== null && typeof e == "object", Ao = (e) => e === !0 || e === !1, Be = (e) => {
  if (Ke(e) !== "object")
    return !1;
  const a = Ka(e);
  return (a === null || a === Object.prototype || Object.getPrototypeOf(a) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, Co = H("Date"), To = H("File"), Oo = H("Blob"), Fo = H("FileList"), Po = (e) => Ye(e) && D(e.pipe), qo = (e) => {
  let a;
  return e && (typeof FormData == "function" && e instanceof FormData || D(e.append) && ((a = Ke(e)) === "formdata" || // detect form-data instance
  a === "object" && D(e.toString) && e.toString() === "[object FormData]"));
}, Lo = H("URLSearchParams"), [Bo, zo, Uo, No] = ["ReadableStream", "Request", "Response", "Headers"].map(H), Do = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
function Ee(e, a, { allOwnKeys: n = !1 } = {}) {
...
const ne = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, vi = (e) => !we(e) && e !== ne;
function Ba() {
  const { caseless: e } = vi(this) && this || {}, a = {}, n = (i, o) => {
    const t = e && xi(a, o) || o;
    Be(a[t]) && Be(i) ? a[t] = Ba(a[t], i) : Be(i) ? a[t] = Ba({}, i) : he(i) ? a[t] = i.slice() : a[t] = i;
  };
  for (let i = 0, o = arguments.length; i < o; i++)
    arguments[i] && Ee(arguments[i], n);
  return a;
}
const Io = (e, a, n, { allOwnKeys: i } = {}) => (Ee(a, (o, t) => {
  n && D(o) ? e[t] = di(o, n) : e[t] = o;
}, { allOwnKeys: i }), e), $o = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e), Mo = (e, a, n, i) => {
  ...
  for (; a-- > 0; )
    n[a] = e[a];
  return n;
}, Go = /* @__PURE__ */ ((e) => (a) => e && a instanceof e)(typeof Uint8Array < "u" && Ka(Uint8Array)), Jo = (e, a) => {
  ...
  for (; (n = e.exec(a)) !== null; )
    i.push(n);
  return i;
}, Xo = H("HTMLFormElement"), Yo = (e) => e.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, i, o) {
    return i.toUpperCase() + o;
  }
), fn = (({ hasOwnProperty: e }) => (a, n) => e.call(a, n))(Object.prototype), Zo = H("RegExp"), hi = (e, a) => {
...
const ot = (e) => {
  ...
  return n(e, 0);
}, tt = H("AsyncFunction"), st = (e) => e && (Ye(e) || D(e)) && D(e.then) && D(e.catch), bi = ((e, a) => e ? setImmediate : a ? ((n, i) => (ne.addEventListener("message", ({ source: o, data: t }) => {
  ...
  D(ne.postMessage)
), rt = typeof queueMicrotask < "u" ? queueMicrotask.bind(ne) : typeof process < "u" && process.nextTick || bi, l = {
  isArray: he,
  isArrayBuffer: mi,
  isBuffer: Eo,
  isFormData: qo,
...
var ki = $.Stream, ct = ve, pt = W;
function W() {
  this.source = null, this.dataSize = 0, this.maxDataSize = 1024 * 1024, this.pauseStream = !0, this._maxDataSizeExceeded = !1, this._released = !1, this._bufferedEvents = [];
}
ct.inherits(W, ki);
W.create = function(e, a) {
  var n = new this();
  a = a || {};
  for (var i in a)
    n[i] = a[i];
...
Object.defineProperty(W.prototype, "readable", {
  configurable: !0,
  enumerable: !0,
  get: function() {
...
W.prototype.setEncoding = function() {
...
W.prototype.release = function() {
  this._released = !0, this._bufferedEvents.forEach((function(e) {
    this.emit.apply(this, e);
  }).bind(this)), this._bufferedEvents = [];
};
W.prototype.pipe = function() {
  var e = ki.prototype.pipe.apply(this, arguments);
  return this.resume(), e;
};
W.prototype._handleEmit = function(e) {
  if (this._released) {
    this.emit.apply(this, e);
    return;
  }
...
W.prototype._checkIfMaxDataSizeExceeded = function() {
...
var lt = ve, _i = $.Stream, xn = pt, ut = C;
function C() {
...
C.prototype.pipe = function(e, a) {
  return _i.prototype.pipe.call(this, e, a), this.resume(), e;
};
 ...
 */
(function(e) {
  var a = mt, n = li.extname, i = /^\s*([^;\s]*)(?:;|\s|$)/, o = /^text\//i;
...
var Si = ht;
function ht(e) {
  Object.keys(e.jobs).forEach(bt.bind(e)), e.jobs = {};
}
function bt(e) {
  typeof this.jobs[e] == "function" && this.jobs[e]();
}
var hn = Ei, gt = Si, ji = yt;
function yt(e, a, n, i) {
  var o = n.keyedList ? n.keyedList[n.index] : n.index;
  n.jobs[o] = wt(a, o, e[o], function(t, s) {
    o in n.jobs && (delete n.jobs[o], t ? gt(n) : n.results[o] = s, i(t, n.results));
  });
}
function wt(e, a, n, i) {
  var o;
  return e.length == 2 ? o = e(n, hn(i)) : o = e(n, a, hn(i)), o;
}
var Ai = kt;
function kt(e, a) {
...
var _t = Si, Rt = Ei, Ci = Et;
function Et(e) {
  Object.keys(this.jobs).length && (this.index = this.size, _t(this), Rt(e)(null, this.results));
}
var St = ji, jt = Ai, At = Ci, Ct = Tt;
function Tt(e, a, n) {
  for (var i = jt(e); i.index < (i.keyedList || e).length; )
    St(e, a, i, function(o, t) {
      if (o) {
        n(o, t);
        return;
      }
...
var Ze = { exports: {} }, bn = ji, Ot = Ai, Ft = Ci;
Ze.exports = Pt;
Ze.exports.ascending = Ti;
Ze.exports.descending = qt;
function Pt(e, a, n, i) {
  var o = Ot(e, n);
  return bn(e, a, o, function t(s, p) {
    if (s) {
      i(s, p);
      return;
    }
...
var Oi = Ze.exports, Lt = Oi, Bt = zt;
function zt(e, a, n) {
  return Lt(e, a, null, n);
}
var Ut = {
  parallel: Ct,
  serial: Bt,
  serialOrdered: Oi
}, Fi = Object, Nt = Error, Dt = EvalError, It = RangeError, $t = ReferenceError, Mt = SyntaxError, sa, gn;
function Xa() {
  return gn || (gn = 1, sa = TypeError), sa;
}
var Ht = URIError, Wt = Math.abs, Vt = Math.floor, Gt = Math.max, Jt = Math.min, Kt = Math.pow, Xt = Math.round, Yt = Number.isNaN || function(a) {
  return a !== a;
}, Zt = Yt, Qt = function(a) {
  return Zt(a) || a === 0 ? a : a < 0 ? -1 : 1;
...
var Pi = ze, Ue = Object.defineProperty || !1;
if (Ue)
  try {
    Ue({}, "a", { value: 1 });
  } catch {
...
function ns() {
  if (wn) return ca;
  wn = 1;
  var e = typeof Symbol < "u" && Symbol, a = qi();
  return ca = function() {
...
var pa, kn;
function Li() {
  return kn || (kn = 1, pa = typeof Reflect < "u" && Reflect.getPrototypeOf || null), pa;
}
var la, _n;
function Bi() {
  if (_n) return la;
...
var ma, Sn;
function Ya() {
  return Sn || (Sn = 1, ma = Function.prototype.call), ma;
}
var fa, jn;
function zi() {
  return jn || (jn = 1, fa = Function.prototype.apply), fa;
}
var xa, An;
function os() {
  return An || (An = 1, xa = typeof Reflect < "u" && Reflect && Reflect.apply), xa;
}
var va, Cn;
function ts() {
  if (Cn) return va;
  Cn = 1;
  var e = Qe(), a = zi(), n = Ya(), i = os();
...
function Ui() {
  if (Pn) return ya;
  Pn = 1;
  var e = Function.prototype.call, a = Object.prototype.hasOwnProperty, n = Qe();
  return ya = n.call(e, a), ya;
}
var R, ps = Fi, ls = Nt, us = Dt, ds = It, ms = $t, fe = Mt, me = Xa(), fs = Ht, xs = Wt, vs = Vt, hs = Gt, bs = Jt, gs = Kt, ys = Xt, ws = Qt, Ni = Function, wa = function(e) {
  try {
    return Ni('"use strict"; return (' + e + ").constructor;")();
  } catch {
  }
}, ke = Pi, ks = as, ka = function() {
  throw new me();
}, _s = ke ? function() {
  try {
...
}() : ka, pe = ns()(), O = cs(), Rs = Bi(), Es = Li(), Di = zi(), Se = Ya(), le = {}, Ss = typeof Uint8Array > "u" || !O ? R : O(Uint8Array), ie = {
  __proto__: null,
  "%AggregateError%": typeof AggregateError > "u" ? R : AggregateError,
  "%Array%": Array,
  "%ArrayBuffer%": typeof ArrayBuffer > "u" ? R : ArrayBuffer,
  "%ArrayIteratorPrototype%": pe && O ? O([][Symbol.iterator]()) : R,
  ...
  "%isFinite%": isFinite,
  "%isNaN%": isNaN,
  "%IteratorPrototype%": pe && O ? O(O([][Symbol.iterator]())) : R,
  "%JSON%": typeof JSON == "object" ? JSON : R,
  "%Map%": typeof Map > "u" ? R : Map,
  "%MapIteratorPrototype%": typeof Map > "u" || !pe || !O ? R : O((/* @__PURE__ */ new Map())[Symbol.iterator]()),
  "%Math%": Math,
  "%Number%": Number,
  "%Object%": ps,
  ...
  "%SetIteratorPrototype%": typeof Set > "u" || !pe || !O ? R : O((/* @__PURE__ */ new Set())[Symbol.iterator]()),
  "%SharedArrayBuffer%": typeof SharedArrayBuffer > "u" ? R : SharedArrayBuffer,
  "%String%": String,
  "%StringIteratorPrototype%": pe && O ? O(""[Symbol.iterator]()) : R,
  "%Symbol%": pe ? Symbol : R,
  "%SyntaxError%": fe,
  "%ThrowTypeError%": _s,
  "%TypedArray%": Ss,
...
var As = function e(a) {
...
}, je = Qe(), $e = Ui(), Cs = je.call(Se, Array.prototype.concat), Ts = je.call(Di, Array.prototype.splice), Ln = je.call(Se, String.prototype.replace), Me = je.call(Se, String.prototype.slice), Os = je.call(Se, RegExp.prototype.exec), Fs = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, Ps = /\\(\\)?/g, qs = function(a) {
  ...
  var o = [];
  return Ln(a, Fs, function(t, s, p, d) {
    o[o.length] = p ? Ln(d, Ps, "$1") : s || t;
  }), o;
}, Ls = function(a, n) {
  var i = a, o;
  if ($e(qn, i) && (o = qn[i], i = "%" + o[0] + "%"), $e(ie, i)) {
    var t = ie[i];
    if (t === le && (t = As(i)), typeof t > "u" && !n)
  ...
  var i = qs(a), o = i.length > 0 ? i[0] : "", t = Ls("%" + o + "%", n), s = t.name, p = t.value, d = !1, u = t.alias;
  u && (o = u[0], Ts(i, Cs([0, 1], u)));
...
var Us = Bs, zn = Us("%Object.defineProperty%", !0), Ns = zs()(), Ds = Ui(), Is = Xa(), Fe = Ns ? Symbol.toStringTag : null, $s = function(a, n) {
  ...
  if (typeof i < "u" && typeof i != "boolean" || typeof o < "u" && typeof o != "boolean")
    throw new Is("if provided, the `overrideIfSet` and `nonConfigurable` options must be booleans");
  Fe && (i || !Ds(a, Fe)) && (zn ? zn(a, Fe, {
    configurable: !o,
    enumerable: !1,
    value: n,
    writable: !1
...
}, Za = ut, Hs = ve, Ra = li, Ws = Ga, Vs = Ja, Gs = Je.parse, Js = go, Ks = $.Stream, Ea = Ri, Xs = Ut, Ys = $s, za = Ms, Zs = E;
Hs.inherits(E, Za);
function E(e) {
  if (!(this instanceof E))
    return new E(e);
  this._overheadLength = 0, this._valueLength = 0, this._valuesToMeasure = [], Za.call(this), e = e || {};
  for (var a in e)
    this[a] = e[a];
}
E.LINE_BREAK = `\r
...
E.prototype.append = function(e, a, n) {
  ...
  var i = Za.prototype.append.bind(this);
...
E.prototype._multiPartHeader = function(e, a, n) {
  ...
  for (var d in s)
    if (Object.prototype.hasOwnProperty.call(s, d)) {
      if (p = s[d], p == null)
        continue;
      Array.isArray(p) || (p = [p]), p.length && (t += d + ": " + p.join("; ") + E.LINE_BREAK);
    }
  return "--" + this.getBoundary() + E.LINE_BREAK + t + E.LINE_BREAK;
};
E.prototype._getContentDisposition = function(e, a) {
  var n, i;
  return typeof a.filepath == "string" ? n = Ra.normalize(a.filepath).replace(/\\/g, "/") : a.filename || e.name || e.path ? n = Ra.basename(a.filename || e.name || e.path) : e.readable && Object.prototype.hasOwnProperty.call(e, "httpVersion") && (n = Ra.basename(e.client._httpMessage.path || "")), n && (i = 'filename="' + n + '"'), i;
};
E.prototype._getContentType = function(e, a) {
  var n = a.contentType;
  return !n && e.name && (n = Ea.lookup(e.name)), !n && e.path && (n = Ea.lookup(e.path)), !n && e.readable && Object.prototype.hasOwnProperty.call(e, "httpVersion") && (n = e.headers["content-type"]), !n && (a.filepath || a.filename) && (n = Ea.lookup(a.filepath || a.filename)), !n && typeof e == "object" && (n = E.DEFAULT_CONTENT_TYPE), n;
};
...
E.prototype.getLength = function(e) {
  ...
  Xs.parallel(this._valuesToMeasure, this._lengthRetriever, function(n, i) {
    if (n) {
      e(n);
      return;
    }
...
E.prototype.submit = function(e, a) {
  ...
  return typeof e == "string" ? (e = Gs(e), i = za({
    port: e.port,
    path: e.pathname,
    host: e.hostname,
    protocol: e.protocol
  }, o)) : (i = za(e, o), i.port || (i.port = i.protocol == "https:" ? 443 : 80)), i.headers = this.getHeaders(e.headers), i.protocol == "https:" ? n = Vs.request(i) : n = Ws.request(i), this.getLength((function(t, s) {
...
function Un(e, a, n) {
  return e ? e.concat(a).map(function(o, t) {
    return o = $i(o), !n && t ? "[" + o + "]" : o;
  }).join(n ? "." : "") : a;
}
function Qs(e) {
  return l.isArray(e) && !e.some(Ua);
}
const er = l.toFlatObject(l, {}, null, function(a) {
  return /^is[A-Z]/.test(a);
});
function ea(e, a, n) {
  if (!l.isObject(e))
    throw new TypeError("target must be an object");
  a = a || new (Ii || FormData)(), n = l.toFlatObject(n, {
    metaTokens: !0,
    dots: !1,
    indexes: !1
  }, !1, function(x, v) {
  ...
  function r(f, x, v) {
    ...
    if (f && !v && typeof f == "object") {
      ...
      else if (l.isArray(f) && Qs(f) || (l.isFileList(f) || l.endsWith(x, "[]")) && (g = l.toArray(f)))
        return x = $i(x), g.forEach(function(y, j) {
          !(l.isUndefined(y) || y === null) && a.append(
            // eslint-disable-next-line no-nested-ternary
            s === !0 ? Un([x], j, t) : s === null ? x : x + "[]",
            u(y)
          );
        }), !1;
    }
    return Ua(f) ? !0 : (a.append(Un(v, x, t), u(f)), !1);
  }
...
function Mi(e, a) {
  this._pairs = [], e && ea(e, this, a);
}
const Hi = Mi.prototype;
Hi.append = function(a, n) {
  this._pairs.push([a, n]);
};
Hi.toString = function(a) {
  const n = a ? function(i) {
    return a.call(this, i, Nn);
  } : Nn;
...
function Qa(e, a, n) {
  if (!a)
    return e;
  const i = n && n.encode || ar;
  l.isFunction(n) && (n = {
    serialize: n
  });
  const o = n && n.serialize;
  let t;
  if (o ? t = o(a, n) : t = l.isURLSearchParams(a) ? a.toString() : new Mi(a, n).toString(i), t) {
    const s = e.indexOf("#");
...
}, nr = Je.URLSearchParams, Sa = "abcdefghijklmnopqrstuvwxyz", In = "0123456789", Wi = {
  DIGIT: In,
  ALPHA: Sa,
  ALPHA_DIGIT: Sa + Sa.toUpperCase() + In
}, ir = (e = 16, a = Wi.ALPHA_DIGIT) => {
  let n = "";
...
}, an = typeof window < "u" && typeof document < "u", Na = typeof navigator == "object" && navigator || void 0, tr = an && (!Na || ["ReactNative", "NativeScript", "NS"].indexOf(Na.product) < 0), sr = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", rr = an && window.location.href || "http://localhost", cr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: an,
...
function pr(e, a) {
  return ea(e, new A.classes.URLSearchParams(), Object.assign({
...
function Vi(e) {
  function a(n, i, o, t) {
    ...
    return s = !s && l.isArray(o) ? o.length : s, d ? (l.hasOwnProp(o, s) ? o[s] = [o[s], i] : o[s] = i, !p) : ((!o[s] || !l.isObject(o[s])) && (o[s] = []), a(n, i, o[s], t) && l.isArray(o[s]) && (o[s] = ur(o[s])), !p);
  }
...
const Ae = {
  ...
  transformRequest: [function(a, n) {
    ...
    if (t && l.isHTMLForm(a) && (a = new FormData(a)), l.isFormData(a))
      return o ? JSON.stringify(Vi(a)) : a;
    ...
    if (t) {
      if (i.indexOf("application/x-www-form-urlencoded") > -1)
        return pr(a, this.formSerializer).toString();
    ...
    return t || o ? (n.setContentType("application/json", !1), dr(a)) : a;
  }],
...
const mr = l.toObjectSet([
  ...
  return e && e.split(`
`).forEach(function(s) {
    o = s.indexOf(":"), n = s.substring(0, o).trim().toLowerCase(), i = s.substring(o + 1).trim(), !(!n || a[n] && mr[n]) && (n === "set-cookie" ? a[n] ? a[n].push(i) : a[n] = [i] : a[n] = a[n] ? a[n] + ", " + i : i);
  }), a;
}, $n = Symbol("internals");
function ge(e) {
...
let P = class {
  ...
  set(a, n, i) {
    ...
    if (l.isPlainObject(a) || a instanceof this.constructor)
      s(a, n);
    else if (l.isString(a) && (a = a.trim()) && !vr(a))
      s(fr(a), n);
...
l.reduceDescriptors(P.prototype, ({ value: e }, a) => {
...
function nn(e, a, n) {
  let i = !gr(a);
  return e && i || n == !1 ? yr(e, a) : a;
}
var Ji = {}, wr = Je.parse, kr = {
  ftp: 21,
  gopher: 70,
  http: 80,
  https: 443,
  ws: 80,
  wss: 443
}, _r = String.prototype.endsWith || function(e) {
  return e.length <= this.length && this.indexOf(e, this.length - e.length) !== -1;
};
function Rr(e) {
  var a = typeof e == "string" ? wr(e) : e || {}, n = a.protocol, i = a.host, o = a.port;
  if (typeof i != "string" || !i || typeof n != "string" || (n = n.split(":", 1)[0], i = i.replace(/:\d*$/, ""), o = parseInt(o) || kr[n] || 0, !Er(i, o)))
    return "";
...
function Er(e, a) {
  ...
  return n ? n === "*" ? !1 : n.split(/[,\s]/).every(function(i) {
    ...
    return s && s !== a ? !0 : /^[.*]/.test(t) ? (t.charAt(0) === "*" && (t = t.slice(1)), !_r.call(e, t)) : e !== t;
  }) : !0;
}
function de(e) {
  return process.env[e.toLowerCase()] || process.env[e.toUpperCase()] || "";
}
Ji.getProxyForUrl = Rr;
var on = { exports: {} }, Pe = { exports: {} }, qe = { exports: {} }, Ca, Mn;
function Sr() {
  if (Mn) return Ca;
  Mn = 1;
...
function Ki() {
  ...
  Hn = 1;
  function e(a) {
    i.debug = i, i.default = i, i.coerce = u, i.disable = p, i.enable = t, i.enabled = d, i.humanize = Sr(), i.destroy = r, Object.keys(a).forEach((c) => {
      i[c] = a[c];
...
var Le = { exports: {} }, Oa, Vn;
function Ar() {
  return Vn || (Vn = 1, Oa = (e, a = process.argv) => {
...
function Cr() {
  if (Gn) return Fa;
  Gn = 1;
  const e = ko, a = ui, n = Ar(), { env: i } = process;
  let o;
...
var Kn;
function Or() {
  return Kn || (Kn = 1, typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? Pe.exports = jr() : Pe.exports = Tr()), Pe.exports;
}
var ye, Fr = function() {
  if (!ye) {
    try {
      ye = Or()("follow-redirects");
    } catch {
    }
...
}, Ce = Je, _e = Ce.URL, Pr = Ga, qr = Ja, tn = $.Writable, sn = wo, Xi = Fr;
(function() {
...
var Lr = [
  ...
  "search",
  "hash"
], cn = ["abort", "aborted", "connect", "error", "socket", "timeout"], pn = /* @__PURE__ */ Object.create(null);
...
var Da = Te(
  ...
  "write after end"
), Nr = tn.prototype.destroy || Zi;
function U(e, a) {
  tn.call(this), this._sanitizeOptions(e), this._options = e, this._ended = !1, this._ending = !1, this._redirectCount = 0, this._redirects = [], this._requestBodyLength = 0, this._requestBodyBuffers = [], a && this.on("response", a);
  var n = this;
  this._onNativeResponse = function(i) {
    try {
      n._processResponse(i);
    } catch (o) {
      n.emit("error", o instanceof Ia ? o : new Ia({ cause: o }));
    }
  }, this._performRequest();
}
U.prototype = Object.create(tn.prototype);
U.prototype.abort = function() {
  un(this._currentRequest), this._currentRequest.abort(), this.emit("abort");
};
U.prototype.destroy = function(e) {
  return un(this._currentRequest, e), Nr.call(this, e), this;
};
U.prototype.write = function(e, a, n) {
  if (this._ending)
    throw new Ur();
  if (!oe(e) && !$r(e))
  ...
  this._requestBodyLength + e.length <= this._options.maxBodyLength ? (this._requestBodyLength += e.length, this._requestBodyBuffers.push({ data: e, encoding: a }), this._currentRequest.write(e, a, n)) : (this.emit("error", new zr()), this.abort());
};
U.prototype.end = function(e, a, n) {
...
U.prototype._sanitizeOptions = function(e) {
...
U.prototype._processResponse = function(e) {
  ...
  if (un(this._currentRequest), e.destroy(), ++this._redirectCount > this._options.maxRedirects)
    throw new Br();
  ...
  var s = Pa(/^host$/i, this._options.headers), p = ln(this._currentUrl), d = s || p.host, u = /^\w+:/.test(n) ? this._currentUrl : Ce.format(Object.assign(p, { host: d })), r = Dr(n, u);
  if (Xi("redirecting to", r.href), this._isRedirect = !0, $a(r, this._options), (r.protocol !== p.protocol && r.protocol !== "https:" || r.host !== d && !Ir(r.host, d)) && Pa(/^(?:(?:proxy-)?authorization|cookie)$/i, this._options.headers), se(o)) {
    var c = {
      headers: e.headers,
      statusCode: a
    }, m = {
...
function Yi(e) {
  ...
  return Object.keys(e).forEach(function(i) {
    ...
    function p(u, r, c) {
      return Mr(u) ? u = $a(u) : oe(u) ? u = $a(ln(u)) : (c = r, r = Qi(u), u = { protocol: o }), se(r) && (c = r, r = null), r = Object.assign({
        maxRedirects: a.maxRedirects,
        maxBodyLength: a.maxBodyLength
      }, u, r), r.nativeProtocols = n, !oe(r.host) && !oe(r.hostname) && (r.hostname = "::1"), sn.equal(r.protocol, o, "protocol mismatch"), Xi("options", r), new U(r, c);
    }
    function d(u, r, c) {
...
function ln(e) {
  ...
  if (rn)
    a = new _e(e);
  else if (a = Qi(Ce.parse(e)), !oe(a.protocol))
    throw new Da({ input: e });
  return a;
}
function Dr(e, a) {
  return rn ? new _e(e, a) : ln(Ce.resolve(a, e));
}
function Qi(e) {
...
on.exports = Yi({ http: Pr, https: qr });
on.exports.wrap = Yi;
var Hr = on.exports;
const Wr = /* @__PURE__ */ wi(Hr), He = "1.8.1";
function eo(e) {
...
const Vr = /^(?:([^;]+);)?(?:[^;]+;)?(base64|),([\s\S]*)$/;
function Gr(e, a, n) {
  const i = n && n.Blob || A.classes.Blob, o = eo(e);
...
const qa = Symbol("internals");
class Xn extends $.Transform {
  constructor(a) {
    a = l.toFlatObject(a, {
      maxRate: 0,
      chunkSize: 64 * 1024,
  ...
  _transform(a, n, i) {
    const o = this[qa], t = o.maxRate, s = this.readableHighWaterMark, p = o.timeWindow, d = 1e3 / p, u = t / d, r = o.minChunkSize !== !1 ? Math.max(o.minChunkSize, u * 0.01) : 0, c = (h, f) => {
...
const { asyncIterator: Yn } = Symbol, ao = async function* (e) {
  e.stream ? yield* e.stream() : e.arrayBuffer ? yield await e.arrayBuffer() : e[Yn] ? yield* e[Yn]() : yield e;
}, Jr = A.ALPHABET.ALPHA_DIGIT + "-_", Re = typeof TextEncoder == "function" ? new TextEncoder() : new ve.TextEncoder(), Y = `\r
`, Kr = Re.encode(Y), Xr = 2;
class Yr {
  constructor(a, n) {
    const { escapeName: i } = this.constructor, o = l.isString(n);
    let t = `Content-Disposition: form-data; name="${i(a)}"${!o && n.name ? `; filename="${i(n.name)}"` : ""}${Y}`;
    o ? n = Re.encode(String(n).replace(/\r?\n|\r\n?/g, Y)) : t += `Content-Type: ${n.type || "application/octet-stream"}${Y}`, this.headers = Re.encode(t + Y), this.contentLength = o ? n.byteLength : n.size, this.size = this.headers.byteLength + this.contentLength + Xr, this.name = a, this.value = n;
  }
  async *encode() {
    yield this.headers;
    const { value: a } = this;
    l.isTypedArray(a) ? yield a : yield* ao(a), yield Kr;
  }
  static escapeName(a) {
...
const Zr = (e, a, n) => {
  const {
    ...
    size: o = 25,
    boundary: t = i + "-" + A.generateString(o, Jr)
  } = n || {};
  if (!l.isFormData(e))
    throw TypeError("FormData instance required");
  if (t.length < 1 || t.length > 70)
    throw Error("boundary must be 10-70 characters long");
  const s = Re.encode("--" + t + Y), p = Re.encode("--" + t + "--" + Y + Y);
  let d = p.byteLength;
  ...
  return Number.isFinite(d) && (r["Content-Length"] = d), a && a(r), bo.from(async function* () {
    for (const c of u)
      yield s, yield* c.encode();
    yield p;
  }());
};
class Qr extends $.Transform {
  __transform(a, n, i) {
    this.push(a), i();
  }
  _transform(a, n, i) {
...
const ec = (e, a) => l.isAsyncFn(e) ? function(...n) {
  const i = n.pop();
...
}, Qn = l.isFunction(Q.createBrotliDecompress), { http: oc, https: tc } = Wr, sc = /https:?/, ei = A.protocols.map((e) => e + ":"), ai = (e, [a, n]) => (e.on("end", n).on("error", n), a);
function rc(e, a) {
...
const cc = typeof process < "u" && l.kindOf(process) === "process", pc = (e) => new Promise((a, n) => {
  let i, o;
  const t = (d, u) => {
    o || (o = !0, i && i(d, u));
  }, s = (d) => {
...
}, ni = (e, a) => lc(l.isObject(e) ? e : { address: e, family: a }), uc = cc && function(a) {
  return pc(async function(i, o, t) {
    let { data: s, lookup: p, family: d } = a;
    const { responseType: u, responseEncoding: r } = a, c = a.method.toUpperCase();
    let m, h = !1, f;
    if (p) {
      const _ = ec(p, (k) => l.isArray(k) ? k : [k]);
      p = (k, q, ae) => {
        _(k, q, (F, X, oa) => {
          if (F)
            return ae(F);
          const G = l.isArray(X) ? X.map((I) => ni(I)) : [ni(X, oa)];
          q.all ? ae(F, G) : ae(F, G[0].address, G[0].family);
        });
      };
    }
    const x = new _o(), v = () => {
    ...
    const w = nn(a.baseURL, a.url), y = new URL(w, A.hasBrowserEnv ? A.origin : void 0), j = y.protocol || ei[0];
    if (j === "data:") {
      let _;
      if (c !== "GET")
        return ue(i, o, {
      ...
      return u === "text" ? (_ = _.toString(r), (!r || r === "utf8") && (_ = l.stripBOM(_))) : u === "stream" && (_ = $.Readable.from(_)), ue(i, o, {
        data: _,
        status: 200,
        statusText: "OK",
        headers: new P(),
    ...
    S.set("User-Agent", "axios/" + He, !1);
    const { onUploadProgress: N, onDownloadProgress: L } = a, M = a.maxRate;
    let V, ce;
    if (l.isSpecCompliantForm(s)) {
      const _ = S.getContentType(/boundary=([-_\w\d]{10,70})/i);
      s = Zr(s, (k) => {
        S.set(k);
      }, {
      ...
      if (S.set(s.getHeaders()), !S.hasContentLength())
        try {
          ...
          Number.isFinite(_) && _ >= 0 && S.setContentLength(_);
        } catch {
        }
    } else if (l.isBlob(s) || l.isFile(s))
      s.size && S.setContentType(s.type || "application/octet-stream"), S.setContentLength(s.size || 0), s = $.Readable.from(ao(s));
    ...
    const fo = l.toFiniteNumber(S.getContentLength());
    l.isArray(M) ? (V = M[0], ce = M[1]) : V = ce = M, s && (N || V) && (l.isStream(s) || (s = $.Readable.from(s, { objectMode: !1 })), s = $.pipeline([s, new Xn({
      maxRate: l.toFiniteNumber(V)
    })], l.noop), N && s.on("progress", ai(
      s,
      We(
        fo,
        xe(Ve(N), !1, 3)
    ...
    !l.isUndefined(p) && (z.lookup = p), a.socketPath ? z.socketPath = a.socketPath : (z.hostname = y.hostname.startsWith("[") ? y.hostname.slice(1, -1) : y.hostname, z.port = y.port, no(z, a.proxy, j + "//" + y.hostname + (y.port ? ":" + y.port : "") + z.path));
    let Oe;
    const ia = sc.test(z.protocol);
    if (z.agent = ia ? a.httpsAgent : a.httpAgent, a.transport ? Oe = a.transport : a.maxRedirects === 0 ? Oe = ia ? Ja : Ga : (a.maxRedirects && (z.maxRedirects = a.maxRedirects), a.beforeRedirect && (z.beforeRedirects.config = a.beforeRedirect), Oe = ia ? tc : oc), a.maxBodyLength > -1 ? z.maxBodyLength = a.maxBodyLength : z.maxBodyLength = 1 / 0, a.insecureHTTPParser && (z.insecureHTTPParser = a.insecureHTTPParser), f = Oe.request(z, function(k) {
      if (f.destroyed) return;
      const q = [k], ae = +k.headers["content-length"];
      if (L || ce) {
        const I = new Xn({
      ...
      if (a.decompress !== !1 && k.headers["content-encoding"])
        switch ((c === "HEAD" || k.statusCode === 204) && delete k.headers["content-encoding"], (k.headers["content-encoding"] || "").toLowerCase()) {
          ...
          case "compress":
          case "x-compress":
            q.push(Q.createUnzip(Zn)), delete k.headers["content-encoding"];
            break;
          case "deflate":
            q.push(new Qr()), q.push(Q.createUnzip(Zn)), delete k.headers["content-encoding"];
            break;
          case "br":
            Qn && (q.push(Q.createBrotliDecompress(ic)), delete k.headers["content-encoding"]);
        }
      F = q.length > 1 ? $.pipeline(q, l.noop) : q[0];
      const oa = $.finished(F, () => {
        oa(), v();
      }), G = {
        status: k.statusCode,
        statusText: k.statusMessage,
        headers: new P(k.headers),
        config: a,
        request: X
      };
      if (u === "stream")
        ...
        F.on("data", function(B) {
          I.push(B), mn += B.length, a.maxContentLength > -1 && mn > a.maxContentLength && (h = !0, F.destroy(), o(new b(
          ...
          f.destroyed || o(b.from(B, null, a, X));
        }), F.on("end", function() {
          try {
            let B = I.length === 1 ? I[0] : Buffer.concat(I);
            u !== "arraybuffer" && (B = B.toString(r), (!r || r === "utf8") && (B = l.stripBOM(B))), G.data = B;
          } catch (B) {
            return o(b.from(B, null, a, G.request, G));
          }
          ue(i, o, G);
        });
      }
      x.once("abort", (I) => {
        F.destroyed || (F.emit("error", I), F.destroy());
      });
    }), x.once("abort", (_) => {
      o(_), f.destroy(_);
...
}, dc = A.hasStandardBrowserEnv ? /* @__PURE__ */ ((e, a) => (n) => (n = new URL(n, A.origin), e.protocol === n.protocol && e.host === n.host && (a || e.port === n.port)))(
  new URL(A.origin),
  A.navigator && /(msie|trident)/i.test(A.navigator.userAgent)
) : () => !0, mc = A.hasStandardBrowserEnv ? (
...
const io = (e) => {
  ...
  a.headers = s = P.from(s), a.url = Qa(nn(a.baseURL, a.url), e.params, e.paramsSerializer), p && s.set(
    "Authorization",
  ...
  if (A.hasStandardBrowserEnv && (i && l.isFunction(i) && (i = i(a)), i || i !== !1 && dc(a.url))) {
    const u = o && t && mc.read(t);
    u && s.set(o, u);
  }
  return a;
}, fc = typeof XMLHttpRequest < "u", xc = fc && function(e) {
  return new Promise(function(n, i) {
    ...
    }, t === void 0 && s.setContentType(null), "setRequestHeader" in v && l.forEach(s.toJSON(), function(j, S) {
...
}, aa = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", oo = aa && typeof ReadableStream == "function", yc = aa && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (a) => e.encode(a))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), to = (e, ...a) => {
  try {
    return !!e(...a);
  } catch {
    return !1;
  ...
  return e && !a;
}), ti = 64 * 1024, Ma = oo && to(() => l.isReadableStream(new Response("").body)), Ge = {
  stream: Ma && ((e) => e.body)
};
aa && ((e) => {
  ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((a) => {
    !Ge[a] && (Ge[a] = l.isFunction(e[a]) ? (n) => n[a]() : (n, i) => {
...
const kc = async (e) => {
  ...
  let h = vc([o, t && t.toAbortSignal()], s), f;
  const x = h && h.unsubscribe && (() => {
    h.unsubscribe();
  });
  let v;
  try {
    if (d && wc && n !== "get" && n !== "head" && (v = await _c(r, i)) !== 0) {
      let S = new Request(a, {
        method: "POST",
        body: i,
        duplex: "half"
      }), N;
      if (l.isFormData(i) && (N = S.headers.get("content-type")) && r.setContentType(N), S.body) {
        const [L, M] = We(
          v,
          xe(Ve(d))
        );
    ...
    let w = await fetch(f);
    const y = Ma && (u === "stream" || u === "response");
    if (Ma && (p || y && x)) {
      const S = {};
      ["status", "statusText", "headers"].forEach((V) => {
        S[V] = w[V];
      });
      const N = l.toFiniteNumber(w.headers.get("content-length")), [L, M] = p && We(
        N,
        xe(Ve(p), !0)
      ) || [];
      w = new Response(
    ...
    u = u || "text";
    let j = await Ge[l.findKey(Ge, u) || "text"](w, e);
    return !y && x && x(), await new Promise((S, N) => {
      ue(S, N, {
        data: j,
...
const si = (e) => `- ${e}`, Ec = (e) => l.isFunction(e) || e === null || e === !1, so = {
  getAdapter: (e) => {
    e = l.isArray(e) ? e : [e];
    const { length: a } = e;
    let n, i;
    ...
    for (let t = 0; t < a; t++) {
      n = e[t];
      let s;
      if (i = n, !Ec(n) && (i = Ha[(s = String(n)).toLowerCase()], i === void 0))
...
` + t.map(si).join(`
`) : " " + si(t[0]) : "as no adapter specified";
      throw new b(
...
function ri(e) {
  return La(e), e.headers = P.from(e.headers), e.data = Aa.call(
    e,
    e.transformRequest
  ), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), so.getAdapter(e.adapter || Ae.adapter)(e).then(function(i) {
    return La(e), i.data = Aa.call(
      e,
      e.transformResponse,
      i
    ), i.headers = P.from(i.headers), i;
  }, function(i) {
    return Gi(i) || (La(e), i && i.response && (i.response.data = Aa.call(
      e,
      e.transformResponse,
      i.response
...
const ci = {};
na.transitional = function(a, n, i) {
  function o(t, s) {
...
` + t) : i.stack = t;
  ...
  getUri(a) {
    ...
    const n = nn(a.baseURL, a.url, a.allowAbsoluteUrls);
    return Qa(n, a.params, a.paramsSerializer);
  }
};
...
function co(e) {
  const a = new te(e), n = di(te.prototype.request, a);
...
T.mergeConfig = re;
T.AxiosHeaders = P;
T.formToJSON = (e) => Vi(l.isHTMLForm(e) ? new FormData(e) : e);
T.getAdapter = so.getAdapter;
T.HttpStatusCode = Wa;
T.default = T;
const {
  Axios: Kc,
...
vo(import.meta.url);
const lo = Z.dirname(ho(import.meta.url));
process.env.APP_ROOT = Z.join(lo, "..");
const Va = process.env.VITE_DEV_SERVER_URL, up = Z.join(process.env.APP_ROOT, "dist-electron"), uo = Z.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = Va ? Z.join(process.env.APP_ROOT, "public") : uo;
let K;
function mo() {
  K = new pi({
    icon: Z.join(process.env.VITE_PUBLIC, "electron-vite.svg"),
    webPreferences: {
      preload: Z.join(lo, "preload.mjs")
    }
  }), K.webContents.on("did-finish-load", () => {
    K == null || K.webContents.send("main-process-message", (/* @__PURE__ */ new Date()).toLocaleString());
  }), Va ? (K.loadURL(Va), K.webContents.openDevTools({ mode: "right" })) : K.loadFile(Z.join(uo, "index.html"));
}
Ie.on("window-all-closed", () => {
  process.platform !== "darwin" && (Ie.quit(), K = null);
});
Ie.on("activate", () => {
  pi.getAllWindows().length === 0 && mo();
});
Ie.whenReady().then(mo);
export {
  up as MAIN_DIST,
  uo as RENDERER_DIST,
