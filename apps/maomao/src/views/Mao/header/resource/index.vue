...
<template>
  ...
  <a-modal v-model:open="open" title="仓库资源" width="80vw" :footer="false" centered :bodyStyle="{ height: '70vh', overflow: 'auto'}">
    <a-row class="h-100">
        ...
        <a-row>
          ...
          <a-descriptions bordered :title="$t('mao.resource')" :column="2" layout="vertical" size="small">
            ...
            <a-descriptions-item :label="$t('mao.stone')">
              <a-tag :color="stoneColor">{{ `${resource.stone} / ${resource.warehouseStore.stone}` }}</a-tag>
            </a-descriptions-item>
